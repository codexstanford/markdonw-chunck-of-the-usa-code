...
(ii) includes with the application a certification by the plan’s actuary described in subparagraph (B), the Secretary shall extend the amortization period for the period of time (not in excess of 5 years) specified in the application. Such extension shall be in addition to any extension under paragraph (2).
