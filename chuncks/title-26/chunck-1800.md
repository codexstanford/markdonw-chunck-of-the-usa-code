...
(II) an event which is reasonably and reliably predictable (as determined by the Secretary), shall not be taken into account until the event on which the benefit is contingent occurs.
