...
(II) provide notification of such selection to the provider or facility (as applicable) and the plan or issuer (as applicable) party to such determination. An entity selected pursuant to the previous sentence to make a determination described in such sentence shall be referred to in this subsection as the “certified IDR entity” with respect to such determination.
...
Each party to a determination under paragraph (5) to which an entity is selected under paragraph (3)  5 in a year shall pay to the Secretary, at such time and in such manner as specified by the Secretary, a fee for participating in the IDR process with respect to such determination in an amount described in subparagraph (B) for such year.
