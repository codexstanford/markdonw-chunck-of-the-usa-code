...
(ii) the denominator of which is the total amount reimbursed to all employees under the plan for such plan year. In determining the fraction under subparagraph (B), there shall not be taken into account any reimbursement which is attributable to a benefit described in subparagraph (A).
