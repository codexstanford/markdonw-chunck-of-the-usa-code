...
(ii) of any quiver, broadhead, or point suitable for use with an arrow described in paragraph (2), a tax equal to 11 percent of the price for which so sold.
...
(ii) measures less than 18 inches overall in length but is suitable for use with a bow described in paragraph (1)(A), a tax equal to 39 cents per shaft.
