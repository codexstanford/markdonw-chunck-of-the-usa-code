...
(C) the orders which are required to be publicly available under section 360(b) of this title ; so as to provide a current record of such rules and orders;
...
(A) to enter into contracts for the acquisition of severable services for a period that begins in one fiscal year and ends in the next fiscal year to the same extent as the head of an executive agency under the authority of section 253 l 2 of title 41, United States Code;
