...
The term “successor to an existing contract” means any contract, other than a roll­over contract, entered into on or after November 9, 1978 , for the first sale of natural gas which was previously subject to an existing contract, whether or not there is an identity of parties or terms with those of such existing contract.
