...
(B) an iterative procedure or algorithm which can be written as a computer program; and from which the results can be objectively replicated, within reasonable limits due to rounding error, through independent application of such statement, procedures, or algorithm, by different qualified individuals.
