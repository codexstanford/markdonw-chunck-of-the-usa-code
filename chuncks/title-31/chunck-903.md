...
(II) 1.5 multiplied by the allowable adjusted taxes of the unit; except that if this amount is less than zero then the excess adjusted taxes of the unit is deemed to be zero.
