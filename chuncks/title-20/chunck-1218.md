...
(iv) in which the borrower is receiving treatment for cancer and the 6 months after such period. 1 and provides that any such period shall not be included in determining the 10-year period described in subparagraph (B);
