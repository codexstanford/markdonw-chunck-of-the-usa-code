...
###### (c) Charge Against Entitlement .

The number of months of entitlement charged an individual under this chapter for a test described in subsection (a) shall be pro-rated based on the actual amount of the fee charged for the test relative to the rate for 1 month payable
