...
(II) for an employee described in clause (i) who is on reserve status, the number of hours for which an employer has agreed to pay such employee on reserve status for any given month,  as established in the applicable collective bargaining agreement or, if none exists, in the employer’s policies.
