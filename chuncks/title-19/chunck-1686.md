...
(C) sustainable development, but does not include the protection of domestic production.
...
(ii) a service or its related operating methods, for common and repeated use, including explanatory and other related provisions set out in a document approved by a standardizing body, with which compliance is not mandatory.
