...
(iii) is located on the Outer Continental Shelf or in or on waters above the Outer Continental Shelf. Such activities include, but are not limited to, platform and drill ship exploration, construction, development, production, processing, and transportation. For purposes of this subsection, emissions from any vessel servicing or associated with an OCS source, including emissions while at the OCS source or en route to or from the OCS source within 25 miles of the OCS source, shall be considered direct emissions from the OCS source.
