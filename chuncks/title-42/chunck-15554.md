...
(G) the promulgation of such rules and regulations to implement the authority described in this paragraph, except that nothing in this section shall be construed as granting to the Department regulatory functions presently within the Nu­clear Regulatory Commission, or any additional functions than those already conferred by law.
